...
type Article struct {
	...
	PublishedAt time.Time `dorm:"published_at" gorm:"column:published_at;default:CURRENT_TIMESTAMP;not null;" json:"published_at"`

	Title    string `dorm:"title" gorm:"title;not_null;unique" json:"title"`
