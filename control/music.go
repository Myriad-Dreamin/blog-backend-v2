...
func PSerializeListMusicsReply(_code int, music *dblayer.Music) *ListMusicsReply {
...
func SerializeListMusicsReply(_code int, music *dblayer.Music) ListMusicsReply {
...
func _packSerializeListMusicsReply(_code int, music *dblayer.Music) ListMusicsReply {
...
func PackSerializeListMusicsReply(_code []int, music []*dblayer.Music) (pack []ListMusicsReply) {
	for i := range _code {
		pack = append(pack, _packSerializeListMusicsReply(_code[i], music[i]))
	}
	return
}
